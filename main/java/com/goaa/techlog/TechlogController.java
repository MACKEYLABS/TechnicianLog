    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("/updateTechlog".equals(path)) {
            ...
            if (techLog != null) {
                ...
                techLog.setReportTime(Time.valueOf(data.get(2).getAsString() + ":00"));
                techLog.setStartTime(Time.valueOf(data.get(3).getAsString() + ":00"));
                techLog.setStopTime(Time.valueOf(data.get(4).getAsString() + ":00"));
